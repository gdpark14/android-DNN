...
public class Classifier{
    ...
    public Pair<Integer, Long> classify(Bitmap image) {
        ...
        double secDiffTimeinsecond =(double) secDiffTime / 1_000_000_000;

        Log.d("DigitClassifier", secDiffTimeinsecond+"");
        return new Pair<Integer,Long>(argmax(result[0]),secDiffTime);
    }



    private Integer argmax(float[] array) {
        int argmax = 0;
        float max = array[0];
